...
const app = require('./app'); // Importation du app.js présent dans le dossier
...
server.listen(process.env.PORT || 3000);// Permet d'écouter les requêtes envoyées ( Si l'env envoie un port à utilisé (Utilisation de ce port), sinon utilisation du port 3000  )